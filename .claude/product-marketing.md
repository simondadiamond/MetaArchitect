...
> `funnel/setup-offer/offer-v4-spec.md` (locked 2026-07-27), `brand/brand-summary.md`.
...
> field notes from real sessions outrank everything in this doc.

## Product Overview
**One-liner:** I set up your business inside the AI you already pay for, so it knows your voice, your rates, your clients — and admin stops eating your evenings.
**What it does:** A hands-on setup service that turns a business owner's Claude subscription into a working business operating system — delivered in Claude's desktop app (Cowork), no code, no terminal. Simon personally installs it, wires it to the owner's real documents and workflows, and trains the owner to independence.
**Product category:** Hands-on AI setup & enablement for small business (the "AI consultant" shelf, deliberately productized).
**Product type:** Productized service ladder (service, not SaaS).
...
| Business OS Setup | $6,500 (founding 3× $5,000) | Fixed scope, ~30 days, skill cap explicit |
...
**Direct:** Local hands-on AI consultants/trainers — FloatAI (Montreal, CAD $150/hr), DigiSmart (audits, no published price), Wellforce ($2.5K–$9.5K flat) — fall short: sell reports/training, not an installed working system; none offer audit-credit risk reversal; none flow improvements back to past clients.
**Secondary (the big one):** **Claude for Small Business** (launched 2026-05-13) — 15 ready-to-run workflows, free with the Claude plan the buyer already has. Falls short: generic workflows for a generic business — a toggle can't hold your voice, your rates, your onboarding checklist, or what you decided about fall pricing. Never argue against it; build on top: "Claude now ships ready-made workflows for a generic small business. You don't run a generic small business."
...
| Term | Meaning |
|------|---------|
| Business OS Setup | The $6,500 flagship install |
| Working Session | $125/hr hands-on hour |
| Kit | Simon's internal skill library (never client-facing vocabulary) |
| Cowork | Claude's desktop app — the delivery surface; page language is "Claude's desktop app" |
