...
- 2026-08-09 (d) — Corrected an over-broad first-pass reading of the orange rule on Command Center (active-nav, selected tabs, and status words had gone orange, reading "consistent use for real interactive states" too liberally). Orange usage is literal on every surface now — see brand-summary.md shared rule 1.
