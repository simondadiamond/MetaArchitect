...
SRC = os.path.join(HERE, 'sample-opportunity-report.src.html')
OUT = os.path.join(HERE, 'sample-opportunity-report.html')
...
html = open(SRC).read()
assert '/*@FONTS@*/' in html, 'source lost a build token'
